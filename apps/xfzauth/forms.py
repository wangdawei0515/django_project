...
class LoginForm(forms.Form,FormMixin):
    telephone1 = forms.CharField(max_length=11,min_length=11,error_messages={"required":"必须输入手机号码！",'min_length':"手机号码个数必须为11位！",'max_length':'手机号码个数必须为11位！'})
...
class RegisterForm(forms.Form,FormMixin):
    telephone = forms.CharField(max_length=11, min_length=11,
                                error_messages={"required": "必须输入手机号码！", 'min_length': "手机号码个数必须为11位！",
