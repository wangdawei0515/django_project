...
class PubCourse(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            Course.objects.create(title=title,video_url=video_url,cover_url=cover_url,price=price,duration=duration,profile=profile,teacher=teacher,category=category)
